...
- **FASTRAD**
  ...
  - **Ray-Tracing Method (RTC):** estimated shielding effectiveness by analyzing path lengths through materials, producing a _sector shielding map_ of radiation exposure.
  - **Forward Monte Carlo (FMC):** simulated particle propagation statistically, calculating the _local deposited dose_ in specific components (e.g., OBC PCB, payload electronics).
